...
import { timeline, smooth, clamp } from './timeline.js?v=cinema-20260913';
import { makeUniverse,themeAt } from './garden_universe.js';
import { rarityFor } from './rarity.js';
import { FrontPrinterEffects } from './printer_effects.js?v=cinema-20260913';
import { addPrinterMechanics } from './printer_mechanics.js?v=cinema-20260913';
...
const copy={
 assembly:['01 / 04','每个部分，<br>找到自己的位置。','底座先稳住，传动机构依次扣合。镜头穿过结构，等最后一片外壳轻轻落定。'],
